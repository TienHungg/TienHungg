...
- Architecting the brand ecosystem at **tienhungsoftware.com** using Monorepo architecture.
- Integrating AI agents (OpenAI, Microsoft Graph API) for automated enterprise workflows (Outlook email parsing, Teams alerts).
- Formulating technical proposals and operational workflows for enterprise software (e.g., PINANCE).
- Managing legacy system migrations and infrastructure using Docker.
...
<div align="center">
  ...
  <img src="https://img.shields.io/badge/Microsoft%20Graph-000000?style=for-the-badge&logo=microsoftoutlook&logoColor=0078D4" alt="Microsoft Graph" />
...
- Keep architecture modular to reduce coupling and improve delivery velocity.
- Favor strict typing, explicit contracts, and observable runtime behavior.
- Design UI with premium minimalism: clarity, spacing, and hierarchy over noise.
